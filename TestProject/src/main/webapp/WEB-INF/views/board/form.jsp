...
<div class="container-fluid px-2 px-md-4">
	...
	<form class="card card-body mx-3 mx-md-4 mt-n6" id="boardForm"
		method="post" action="/board/insert.do" enctype="multipart/form-data">
		...
		<div class="row gx-4 mb-2">
			<div class="col-md-12">
				<div class="input-group input-group-outline mb-4">
					<input type="text" class="form-control" id="boTitle" name="boTitle"
						value="${board.boTitle}" placeholder="제목을 입력해주세요.">
				</div>
			</div>
			<div class="col-md-12">
				<div class="input-group input-group-outline mb-4">
					<textarea class="form-control" cols="50" rows="20" id="boContent"
						name="boContent">${board.boContent }</textarea>
				</div>
			</div>
			<div class="col-md-12">
				<div class="input-group input-group-outline mb-4">
					<input type="file" class="form-control" id="boFile" name="boFile"
						multiple="multiple" />
				</div>
			</div>
			<div class="col-md-12">
										...
										<a class="d-block blur-shadow-image text-center"> 
											<c:choose>
												<c:when test="${fn:split(boardFile.fileMime, '/')[0] eq 'image'}">
														...
														style="width:50%;" alt="img-blur-shadow" class="img-fluid shadow border-radius-lg">
												</c:when>
												<c:otherwise>
														<img src="${pageContext.request.contextPath }/resources/assets/img/icons/img.jpg">
												</c:otherwise>											
											</c:choose>										
										</a>
										<div class="colored-shadow"
											style="background-image: url(&quot;https://images.unsplash.com/photo-1536321115970-5dfa13356211?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;ixlib=rb-1.2.1&amp;auto=format&amp;fit=crop&amp;w=934&amp;q=80&quot;);"></div>
									</div>
									<div
										...
										<p
											class="mb-0 text-xs font-weight-bolder text-info text-uppercase">
											<button type="button" id="btn_${boardFile.fileNo }" 
											class="btn btn-primary fileDelete">delete</button>
										</p>
									</div>
								</div>
							</div>
			...
			<div class="col-md-12">
				...
				<button type="button" class="btn btn-outline-danger"
					onclick="javascript:location.href='/board/detail.do?boNo=${board.boNo}'">취소</button>
				</c:if>
