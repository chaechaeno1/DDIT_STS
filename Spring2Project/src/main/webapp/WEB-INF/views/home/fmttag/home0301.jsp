...
<body>
		...
		<h4>7) type 속성을 time으로 지정하여 시간 포맷팅을 한다.</h4>
		...
		date full : <fmt:formatDate value="${now }" type="time" timeStyle="full"/><br/>

		<h4>8) type 속성을 both로 지정하여 날짜 및 시간 둘다 포맷팅을 한다.</h4>
		...
		date full : <fmt:formatDate value="${now }" type="both" dateStyle="full" timeStyle="full"/><br/>
